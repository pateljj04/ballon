...
csvresult.write("Log #" + "," + "Date" + "," "Time" + "," "Temperature (*F)" + "," "Humidity (%)" + ","
"Pressure" + "," "Internal Temperature (*F)" + "," "Internal Humidity (%)" + "," "Image Link" + "\n")
csvresult.close
Count = 1
while(Count < 99999):
import time
...
csvresult = open("/home/pi/Desktop/SpaceBalloonLog.csv","a")
csvresult.write(('{}'.format(Count)) + "," + Date + "," + Time + "," + ('{0:0.1f},
{1:0.1f}'.format(temperature, humidity)) + "," + str(pressure) + "," + str(tempinf) + "," + str(humidin) +
"," + "file:///home/pi/Space%20Balloon%20Pictures/" + stamp + ".jpg" + "\n")
csvresult.close
print("Data Logged")
